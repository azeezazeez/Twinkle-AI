...
public class GeminiService {
    ...
    public String generateResponse(
        ...
        return generateResponse(userMessage, conversationHistory, attachmentDataUrls, null);
    }
    ...
    public String generateResponse(
        ...
        Map<String, Object> systemInstruction = Map.of(
                "parts", List.of(Map.of("text", systemPrompt(requestedLanguage)))
        );
    ...
    private String systemPrompt(String requestedLanguage) {
    ...
    private String buildLanguageInstruction(String requestedLanguage) {
        ...
        return name == null
                ...
                : "The user selected " + name + ". Respond entirely in " + name + " unless the user explicitly asks for another language. "
