...
public class UserService {
    ...
    // ============================================================
    // CREATE USER FOR PASSWORDLESS OTP AUTHENTICATION
    // ============================================================

    @Transactional
    public User createOtpUser(String email) {
        ...
        try {
            ...
            while (userRepository.existsByUsername(username)) {
                ...
                int maxBaseLength =
                        Math.max(1, 50 - suffixText.length());
                ...
                username = shortenedBase + suffixText;
            }
            ...
            log.info(
                    "OTP user created - ID: {}, username: {}, email: {}",
                    saved.getId(),
                    saved.getUsername(),
                    saved.getEmail()
            );
            ...
            log.error(
                    "Database error creating OTP user: {}",
                    e.getMessage(),
                    e
            );
    ...
    @Transactional
    public User updateUsername(Long userId, String requestedUsername) {
        ...
        if (username.contains("@")) {
            throw new AIServiceException("Username cannot be an email address");
        }
